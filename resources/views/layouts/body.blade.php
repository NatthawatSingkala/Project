						...
						<div class="form-inline my-2 my-lg-0">
							<ul class="navbar-nav mr-auto">
									<li class="nav-item @yield('Signin')">
										...
										<a class="navbar-brand" href="Sign In"><i class="material-icons"style="font-size:20px;">person</i> Sign In</a>
									</li>
									<li class="nav-item @yield('Register')">
										<a class="navbar-brand" href="Register"><i class="material-icons"style="font-size:20px;">person_add</i> Register</a>
									</li>
							</ul>
						</div>
					</div>
